  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-light navbar-expand-lg mt-0" style="background: #fff">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li>
                <a class="nav-link" href=PatientEdit.php>Paciento informacijos redagavimas</a>
            </li>
        </div>
    </nav>
    <br> 
    ...
    <div class="form-group login">
		  	<form method='post'>
				...
				<div style="text-align: left;">
				  	...
				  	<input name='vardas' type='text' class="form-control" readonly>
				</div>
				<br>
				<div style="text-align: left;">
                ...
                <div style="text-align: left;">
				 	<label for="asmens_kodas">Paciento asmens kodas:</label>
				  	<input name='asmens_kodas' type='text' class="form-control" readonly>
				</div style="text-align: left;">
				<br>
                <div style="text-align: left;">
				 	<label for="el_pastas">Paciento el. paštas:</label>
				  	<input name='el_pastas' type='email' class="form-control" readonly>
				</div style="text-align: left;">
				<br>
                <div style="text-align: left;">
				 	<label for="telefonas">Paciento telefono numeris:</label>
				  	<input name='telefonas' type='text' class="form-control" readonly>
				</div style="text-align: left;">
				<br>
                <div style="text-align: left;">
				 	<label for="gimimo_data">Paciento gimimo data:</label>
				  	<input name='gimimo_data' type='date' class="form-control" readonly>
				</div style="text-align: left;">
				<br>
                <div style="text-align: left;">
				 	<label for="adresas">Paciento telefono numeris:</label>
				  	<input name='adresas' type='text' class="form-control" readonly>
		 	</form>
		</div>
</body>
</html>